...
const {signIn, signInViaApple, signInViaGoogle} = useAuthentication();
...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 class="mt-6 text-black text-2xl font-semibold text-center">Login</h2>
    </div>
      ...
      <div class="bg-white shadow sm:rounded-lg">
        ...
        <div class="mt-12">
          <div class="w-[360px] text-center">
            <span class="text-[#333333] text-sm font-light leading-snug">Du hast noch keinen Account? </span>
            <NuxtLink class="text-[#333333] text-sm font-semibold" to="/auth/register">Jetzt Registrieren</NuxtLink>
          </div>
        </div>
