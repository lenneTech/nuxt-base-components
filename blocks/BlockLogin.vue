      ...
      <div class="shadow sm:rounded-lg">
        ...
        <div class="mt-12">
          <div class="text-center">
            <span class="text-sm font-light leading-snug">Du hast noch keinen Account? </span>
            <NuxtLink class="text-sm font-semibold" to="/auth/register">Jetzt Registrieren</NuxtLink>
          </div>
        </div>
